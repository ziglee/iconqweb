                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="dataInscricaoInicio"><g:message code="concurso.dataInscricaoInicio.label" default="Data Inicio Inscricao" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="dataInscricaoFim"><g:message code="concurso.dataInscricaoFim.label" default="Data Fim Inscricao" /></label>
                                </td>
