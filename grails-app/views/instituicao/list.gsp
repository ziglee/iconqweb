                ...
                <table>
                    ...
                    <g:each in="${instituicaoInstanceList}" status="i" var="instituicaoInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            <td><g:link action="show" id="${instituicaoInstance.id}">${fieldValue(bean: instituicaoInstance, field: "id")}</g:link></td>
                            <td>${fieldValue(bean: instituicaoInstance, field: "sigla")}</td>
